...
class mainGame(Scene):
    def __init__(self, director):
        ...
        self.plyr = pygame.font.Font("fonts\AD.ttf", 20 * director.scale)
        ...
        self.apple = Entity(191 * director.scale, 191 * director.scale, 9 * director.scale, 9 * director.scale, (199, 10, 10))
    ...
    def gameEnd(self, screen):
        self.txt = self.plyr.render("esc", True, (255, 255, 255))
        screen.blit(self.txt, (25 * self.director.scale, 1 * self.director.scale))
        gfxdraw.filled_trigon(screen, 5 * self.director.scale, 19 * self.director.scale, 20 * self.director.scale, 26 * self.director.scale, 20 * self.director.scale, 12 * self.director.scale, (232, 107, 35))
        gfxdraw.aatrigon(screen, 5 * self.director.scale, 19 * self.director.scale, 20 * self.director.scale, 26 * self.director.scale, 20 * self.director.scale, 12 * self.director.scale, (232, 107, 35))
